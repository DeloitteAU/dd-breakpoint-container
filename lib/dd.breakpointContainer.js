...
var css = ".bpc{width:100%}.-debug{position:relative}.-debug .bpc__debugIndicator,.-debug>.bpc__content:not(.bpc__browser)~.bpc__debugIdentifier{color:#000;background-color:#fff;border:1px dashed #000;font-size:10px;display:block;position:absolute;top:0;min-height:15px;z-index:9999;padding:0 3px;font-family:monospace;content:\"none\"}.-debug .bpc__debugIdentifier{right:0}.-debug>.bpc__content:not(.bpc__browser){border:1px dashed #000}.-debug>.bpc__browser~.bpc__debugIndicator{position:fixed;border-style:solid;top:0;left:0}";
styleInject(css);

var _BpContexts,
    _jsxFileName = "/Users/sacameron/Sites/dd-breakpoint-container/src/index.js";
// Variables
// ------------------------
