import { createElement, PureComponent, cloneElement, isValidElement, createContext, Fragment, Component } from 'react';
...
var BP_CONTEXTS = (_a = {},
    _a[ID_DEFAULT] = createContext(null),
    _a[ID_BROWSER] = createContext(null),
    _a);
/**
 * TODO.
 */
var WithContext = function (_a) {
    ...
    if (hasIdentifier && !BP_CONTEXTS[identifier]) {
        BP_CONTEXTS[identifier] = createContext(null);
    }
    ...
    return (createElement(Fragment, null, hasIdentifier ? (createElement(IdentifierContext.Provider, { value: currentBp },
        createElement(CoreContext.Provider, { value: currentBp }, children))) : (createElement(IdentifierContext.Provider, { value: currentBp }, children))));
};
...
var BreakpointDefinitions = createContext(BREAKPOINTS);
var AppBreakpoint = createContext({});
...
var BreakpointContainer = /** @class */ (function (_super) {
    ...
    BreakpointContainer.prototype.render = function () {
        ...
        return (createElement(BreakpointDefinitions.Consumer, null, function (breakpoints) {
            var _a;
            ...
            var classBps = matchingBps
                ...
                .join(' ');
            return (createElement("div", { className: classnames(CLASSES.CORE, containerClass, (_a = {},
...
var BrowserContainer = function (_a) {
    ...
    return (createElement(BreakpointContainer, __assign({ identifier: ID_BROWSER, className: SELECTORS$1.BP_BROWSER, debug: DEBUG_BROWSER, customBreakpoints: customBreakpoints }, props), function (bpName, bpSize) { return (createElement(BreakpointDefinitions.Provider, { value: customBreakpoints || BREAKPOINTS },
...
var withBpcTemplate = function (BreakpointWrapper, Component, bpcProps) {
    var WithBpc = function (props) { return (createElement(BreakpointWrapper, __assign({}, bpcProps), function (bpName, bpSize) { return (createElement(Component, __assign({}, props, {
        bpName: bpName,
        bpSize: bpSize,
    }))); })); };
...
var Breakpoint = function (_a) {
    ...
    return (createElement(Context.Consumer, null, function (bp) { return resolveBp(bpQuery.toString(), bp) && children; }));
};
...
export { AppBreakpoint, BREAKPOINTS, Breakpoint, BreakpointContainer, BrowserContainer, bpc, getBpUpperLimit, resolveBp, withBreakpointContainer, withBrowserContainer };
